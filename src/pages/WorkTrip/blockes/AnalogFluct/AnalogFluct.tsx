...
import styles from "./AnalogFluct.module.scss";

export const AnalogFluct = (): ReactElement => {
  return (
    <div className={styles.analog_fluct}>
      <Typography marginTop={"8px"}>
        В данной работе полезный аналоговый сигнал является сложным и состоит из суммы трех
        гармоник:
      </Typography>
      ...
      <Typography marginTop={"16px"}>
        Где A - амплитуда, которую вы задаете, t - момент времени в определенной точке.
      </Typography>
      <Typography marginTop={"8px"}>
        ...
        заметна или ее нету. Так же
        выбрать тип помехи: <strong>«Флуктуационная помеха»</strong>.
      </Typography>
      <Typography marginTop={"8px"}>
      ...
      <Typography marginTop={"16px"}>
        ...
        <strong>«Флуктуационной помехи»</strong>.
      </Typography>
      <DenseTable />
    </div>
  );
